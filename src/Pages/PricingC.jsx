        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 bg-white rounded-2xl hover:shadow-2xl hover:scale-105 duration-1000'>
            ...
            <button   onClick={handleSubmit}
             className='bg-blue-600 w-fit rounded-full font-medium my-6 mx-auto text-white px-6 py-3 hover:bg-blue-700 transition duration-1000 ease-in-out'>Purchase Now</button>
          </div>
          {/* Second Card */}
          <div className='w-full shadow-xl flex flex-col p-4 my-4 bg-white rounded-2xl hover:shadow-2xl hover:scale-105 duration-1000'>
