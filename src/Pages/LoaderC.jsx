...
function LoaderC() {
  ...
  return (
    ...
    <>
       <h1 className='text-center text-white font-bold md:text-3xl text-xl m-5'>Our Clients</h1>
    <div className='text-white flex justify-center max-w-[1250px] mx-auto py-10 flex-wrap' ref={loaderRef}>
                     
      {counters.map((counter, index) => (
        <div key={index} className="text-center p-10 border-red-700 w-full lg:w-1/4" data-aos="fade-right">
