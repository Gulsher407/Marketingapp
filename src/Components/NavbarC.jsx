...
function NavbarC() {
  ...
  return renderNavbar() && (
    <nav id="navbar" className={`text-white ${isSticky ? 'sticky' : ''}`}>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <LinkButton to="/signup">Register Now</LinkButton>
              <LinkButton to="/Adashboard">Admin</LinkButton>
            </div>
          </div>
        </div>
...
function LinkButton({ to, children }) {
  return (
    <Link to={to} className="bg-blue-700 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg mr-4">{children}</Link>
  );
}
