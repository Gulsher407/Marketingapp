...
function Dashboard() {
  ...
  return (
    <div className="flex justify-center items-center h-screen rounded-xl bg-white mx-4">
      <div className="text-center animate-bounce">
        <h1 className="lg:text-8xl md:text-4xl  text-3xl font-bold mb-5 ">Welcome!! {colorfulText}</h1>
