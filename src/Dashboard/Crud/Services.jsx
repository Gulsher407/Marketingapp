...
import { showUsers, deleteUser } from '../../features/Userdetails';
                ...
                {currentUsers.map(user => (
                    <div key={user.id} className="max-w-sm rounded overflow-hidden shadow-lg">
                        ...
                        <div className="py-4 flex justify-around">
                            ...
                            <Link to={`/Aedit/${user.id}`} className="text-[#00008B] border-2 border-[#00008B] hover:text-white rounded-full p-2 mr-2 hover:bg-[#00008B] focus:outline-none"> <RiEditLine size={22} /></Link>
